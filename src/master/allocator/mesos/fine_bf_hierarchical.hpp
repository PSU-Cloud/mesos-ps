...
typedef FineBFHierarchicalAllocatorProcess<DRFSorter, DRFSorter, DRFSorter>
FineBFHierarchicalDRFAllocatorProcess;

typedef MesosAllocator<FineBFHierarchicalDRFAllocatorProcess>
FineBFHierarchicalDRFAllocator;
...
// Best-fit heuristics is currently support DRF only.
class FineBFHierarchicalAllocatorProcess : public MesosAllocatorProcess
{
public:
  FineBFHierarchicalAllocatorProcess(
  ...
  virtual ~FineBFHierarchicalAllocatorProcess() {}

  process::PID<FineBFHierarchicalAllocatorProcess> self() const
  {
...
protected:
  ...
  typedef FineBFHierarchicalAllocatorProcess Self;
  typedef FineBFHierarchicalAllocatorProcess This;
...
template <
    ...
    typename QuotaRoleSorter>
class FineBFHierarchicalAllocatorProcess
  : public internal::FineBFHierarchicalAllocatorProcess
{
public:
  FineBFHierarchicalAllocatorProcess()
    : ProcessBase(process::ID::generate("fine-bf-hierarchical-allocator")),
      internal::FineBFHierarchicalAllocatorProcess(
          [this]() -> Sorter* {
