...
typedef FineHierarchicalAllocatorProcess<DRFSorter, DRFSorter, DRFSorter>
FineHierarchicalDRFAllocatorProcess;

typedef MesosAllocator<FineHierarchicalDRFAllocatorProcess>
FineHierarchicalDRFAllocator;

typedef FineHierarchicalAllocatorProcess<PSDSFSorter, PSDSFSorter, PSDSFSorter>
FineHierarchicalPSDSFAllocatorProcess;
...
class FineHierarchicalAllocatorProcess : public MesosAllocatorProcess
{
public:
  ...
  virtual ~FineHierarchicalAllocatorProcess() {}

  process::PID<FineHierarchicalAllocatorProcess> self() const
  {
...
protected:
  ...
  typedef FineHierarchicalAllocatorProcess Self;
  typedef FineHierarchicalAllocatorProcess This;
...
template <
    ...
    typename QuotaRoleSorter>
class FineHierarchicalAllocatorProcess
  : public internal::FineHierarchicalAllocatorProcess
{
public:
  FineHierarchicalAllocatorProcess()
    : ProcessBase(process::ID::generate("fine-hierarchical-allocator")),
      internal::FineHierarchicalAllocatorProcess(
          [this]() -> Sorter* {
